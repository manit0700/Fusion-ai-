...
public class SignUp extends javax.swing.JFrame {
    ...
    public void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(username.length() > 10){   // username validity
            JOptionPane.showMessageDialog(jButton1 , "Username needs to be shorter than 10 characters");
        }
        else if(!isValid(email)){    // email validity
            JOptionPane.showMessageDialog(jButton1 , "Enter a valid email");
        }
        else if(!isValidPassword(password)){   // password validity check
            ...
            new writeCSV().writeFile(path, username, email, password);
            dispose();
        }    
    }
